      ...
      <main className="flex-1 flex flex-col items-center pt-20 sm:pt-24 pb-20 px-4">
        ...
        <div className="max-w-md space-y-4 w-full">
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">1. Skoin Purchases</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">2. No Monetary Value</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">3. Unauthorized Transactions</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">4. Technical Issues</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">5. Account Termination</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">6. Chargebacks</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">7. Contact</h3>
