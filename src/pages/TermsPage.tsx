      ...
      <main className="flex-1 flex flex-col items-center pt-20 sm:pt-24 pb-20 px-4">
        ...
        <div className="max-w-md space-y-4 w-full">
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">1. Eligibility</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">2. Account Responsibilities</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">3. Acceptable Use</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">4. User Content</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">5. Skoin & Payments</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">6. Privacy</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">7. Termination</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">8. Disclaimers</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">9. Limitation of Liability</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">10. Changes to Terms</h3>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">11. Contact</h3>
