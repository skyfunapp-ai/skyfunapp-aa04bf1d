      ...
      <main className="flex-1 flex flex-col items-center pt-20 sm:pt-24 pb-20 px-4">
        ...
        <div className="max-w-md space-y-4">
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">Your Privacy Matters</h2>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">Safe Meetups</h2>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">Report Concerns</h2>
          ...
          <div className="bg-card/80 backdrop-blur rounded-xl p-4 border border-border/50">
            <h2 className="font-semibold text-card-foreground mb-2">No Harassment Policy</h2>
            <p className="text-muted-foreground text-sm">By using this app, you agree not to harass others; reported incidents will be investigated. Harassment of any sort is prohibited. Reported violations may lead to suspension or permanently deleting your account.</p>
          </div>
        </div>
      </main>
